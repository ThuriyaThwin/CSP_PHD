...
in a manner dependent on the state of the search \cite{Wallace.macheur,Karpas.maxornot}.
...
achieved when the solution count is estimated only in a <em>small fraction of
...
deploying heuristics for planning \cite{Karpas.maxornot}. The approach
