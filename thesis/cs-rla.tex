...
\emph{deferred evaluation} of heuristics in the context of
the Fast Downward Planning System. The technique can be considered a
special case of \lazyastar~where the first heuristic is identically
zero. 
