...
tremendous volume of research on search in various settings\chg{~\cite{Ben-Gal.search}}, it is
...
algorithms. Chapter~\ref{ch:ramesrch} describes \chg{the current state
of the art} of application of the
