...
exceeds the cost of performing a measurement (the right-hand side of
...
almost as high as of the original algorithm in the former case, and is
higher than of Monte-Carlo algorithm performing the same number of
