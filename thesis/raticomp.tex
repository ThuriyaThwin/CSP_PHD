...
in this paper the content is on-line most informative measurement
...
\subsection{The Measurement Selection Problem}
\label{sec:greedy}
...
Section~\ref{sec:svm} for a case study). While there are heuristics
...
w.r.t. computational resources. The focus of this paper is to explore
an improvement in the algorithm due to selective VOI
recomputation.

\subsection{Rational Computation of the Value of Information}
\label{sec:rational}
...
$\varsigma_j^2$ is used in this paper, although other distributions
...
\subsection{\normalsize Obtaining Uncertainty Parameters}
...
(Section~\ref{sec:empirical}) confirm this estimate.

\subsection{\normalsize Empirical Evaluation}
\label{sec:empirical}
...
\subsection{\normalsize Conclusion and Further Research}
\label{sec:conclusion}

The paper proposes an improvement to a widely used class of VOI-based
