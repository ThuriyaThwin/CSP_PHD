...
rational recomputing algorithm was comparable to or higher than the
...
rational recomputing algorithm and of the original algoritms are
essentially the same, despite that much fewer VOI estimations are
...
when the cost of estimating the VOI of all measurements achieves or
exceeds the cost of performing a measurements (the right-hand side of
...
asymptotically from above the reward of uninformed sampling (the
Monte-Carlo algorithm). 

Overall, the rational recomputing algorithm 
