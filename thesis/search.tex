...
the utlity values at the end of the game are always equal and
...
states resulting from every possible respone by MIN. Given a game
...
The {\bf minimax algorithm} recursively computes the minimax decision from the
